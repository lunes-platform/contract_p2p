const pair_options = [
    ...
    { label: 'LITECOIN', type: 'BTC:BTC',DECIMAL:8, ERC_20:false,explorer:"https://live.blockcypher.com/ltc/tx/",explorerTest:"https://live.blockcypher.com/ltc-textnet/tx/" },
    { label: 'DASH', type: 'BTC:BTC',DECIMAL:8, ERC_20:false,explorer:"https://live.blockcypher.com/dash/tx/",explorerTest:"https://live.blockcypher.com/dash-testnet/tx/" },
    { label: 'DOGCOIN', type: 'BTC:BTC',DECIMAL:8, ERC_20:false,explorer:"https://live.blockcypher.com/doge/tx/",explorerTest:"https://live.blockcypher.com/doge-testnet/tx/" },
