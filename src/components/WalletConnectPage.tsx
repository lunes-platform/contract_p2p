    ...
    return (
        ...
        >
            ...
            <Grid item xs={12}
                ...
                <div>
                    <h2>Decentralized OTC Rules:</h2>

                    <p>Our peer-to-peer (OTC) system operates with a set of conditions aimed at ensuring transparency, security, and efficiency in transactions. Below are the main rules to be followed:</p>

                    <ol>
                        <li><strong>Transaction Fee:</strong><br />
                            Every OTC transaction will be subject to a fee, which will be automatically deducted from the total transaction amount.</li>

                        <li><strong>Trading Time:</strong><br />
                            The system will determine a specific time for the completion of the OTC transaction.</li>

                        <li><strong>Penalty for Non-Execution:</strong><br />
                            If a OTC purchase is not executed, a penalty will be applied. This penalty must be paid before making a new purchase.</li>

                        <li><strong>Value Reservation for 24h:</strong><br />
                            When making a purchase in OTC, the value will be reserved for 24 hours, awaiting the seller's deposit.</li>
                    ...
                    <p>These are the main guidelines for the operation of our decentralized OTC. We recommend careful reading and understanding of these rules before initiating any transaction.</p>
                </div>
            </Grid>
